define(['backbone','backbone_views/department/addDepartment'],function (Backbone,add) {
	...
	var employee = Backbone.View.extend({
		...
		{
			//console.log(res);
			$("#addemployeetodepartment").addClass('active');
			...
			var options = {
			  url: URL,
				...
				caption: "Add Employee To Department",
