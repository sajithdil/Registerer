					...
					buttons : {
						"Yes": function() {
							if($( "#deptStartDate" ).val()!="" && $( "#deptStartDate" ).val()!="")
							{
								...
								$.post(URL + "/department/" + $('#addEmpDepGrid').jqGrid('getCell', rowId, 'dept_no') + "/"+$('#perGrid').jqGrid('getCell', rowId, 'emp_no')+"?start="+$( "#deptStartDate" ).val()+"&start="+$( "#deptEndDate" ).val(),function(res){
